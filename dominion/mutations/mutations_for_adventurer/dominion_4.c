...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
	...
	/* XXX: original code was : 	if (state->deckCount[currentPlayer] <1){//if the deck is empty we need to shuffle discard and add to deck */
	if (state->deckCount[ -1 + currentPlayer] <1){//if the deck is empty we need to shuffle discard and add to deck
